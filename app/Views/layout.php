...
<head>
    ...
    <title><?= isset($title) ? "{$title} | Peace Cafe Pontianak" : "Peace Cafe Pontianak" ?></title>
...
<body>
        ...
        <div class="navbar navbar-expand-lg navbar-light" style="background-color: #ecf0f1;">
            <div class="container">
                <a href="/" class="navbar-brand d-flex align-items-center">
                    <strong>Peace Cafe Pontianak</strong>
                </a>
    ...
    <footer class="text-muted py-5">
        <div class="container">
            <p class="mb-1">Copyright © 2021, Peace Cafe Pontianak</p>
        </div>
    </footer>
</body>

                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="<?= validate_url($item->gambar) ? $item->gambar : "/uploads/{$item->gambar}"; ?>"
                                width="100" height="100" class="img-fluid img-thumbnail img-responsive rounded-circle"
                                alt="<?= $item->nama; ?>">
                        </td>
                        <td><?= $item->kategori; ?></td>
                        <?php if (!isset($pager)) : ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Oupss..</h4><button class="btn-close" type="button" data-bs-dismiss="modal"
